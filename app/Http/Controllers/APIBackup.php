...
class Api extends Controller
{
    ...
    {
		$brands=Brand::select('categories.name as c_name', 'brands.name','brands.btl_size','brands.peg_size')->join('categories', 'brands.category_id', '=', 'categories.id')->where(['brands.status' => 1])->get();
